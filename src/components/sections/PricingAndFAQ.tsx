  ...
  const plans = [
    {
      name: 'Облачный',
      price: '29 000',
      users: 'размещение на наших серверах',
      popular: true,
      features: [
    ...
    },
    {
      name: 'On-premise',
      price: '88 000',
      users: 'размещение в вашем контуре',
      features: [
        'Все возможности облачной версии',
        'Размещение ПО в вашем контуре',
      ...
      <section id="цены" className="py-8 md:py-20 px-4 bg-muted/30">
        <div className="container mx-auto">
          <div className="text-center mb-6 md:mb-16">
            ...
            <h2 className="text-xl sm:text-2xl md:text-4xl font-bold mb-2 md:mb-4 px-4">Сколько стоит?</h2>
          </div>
